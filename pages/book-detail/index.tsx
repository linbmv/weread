...
const LEGACY_STYLE_ANNOTATION_GROUP_TIME_WINDOW = 1000;

const getRelatedStyleAnnotationIds = (styleAnnotation: ReaderAnnotation, annotations: ReaderAnnotation[]): string[] => {
...
const createBookmarkExcerpt = (value: string): string => {
...
const ReaderPageBookmarkControl = ({
  active,
  onToggle,
}: {
  active: boolean;
...
const hasCompleteChapterStartPages = (
